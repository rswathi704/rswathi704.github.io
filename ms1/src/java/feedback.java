        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<body>");
             try 
             {
                ...
                PreparedStatement ps1=con.prepareStatement("select eventtype,venuename from bookanevent where bookingid=?");
                ps1.setInt(1,bid);
                ...
                PreparedStatement ps = con.prepareStatement("insert into feedback(bookingid,eventtype,venuename,feedback)"
                        + " values(?,?,?,?)");
                ps.setInt(1,bid);
                ps.setString(2,type);
                ...
                out.println("<script>alert('Your feedback has been registered. Thank You!!')</script>");
